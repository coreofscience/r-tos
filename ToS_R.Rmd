...
source("ToS_old_algorithm_DS.R")
  arbol <- tos_wos(c("data/Marketing Viral 189.txt"))
```
...
```{r}
View(arbol$tos)
write.csv(arbol$tos, file = "data/Marketing Viral.csv")
```

Para guardar el archivo de la red
OJO. Modifique donde dice su_red y ponga un nombre a su red
```{r}
write.graph(arbol$graph, file = "data/Marketing Viral.graphml", format = "graphml")
```
